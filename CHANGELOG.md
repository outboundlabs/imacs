...
- **Completeness Analysis Enhancements**
...
- **Enhanced CLI**
  - `completeness` command supports both single spec and directory (suite) analysis
  - `validate` command with `--strict`, `--fix`, `--dry-run`, and `--all` flags
  - `schema` command for generating JSON schemas
  - Improved error messages and actionable suggestions
...
[Unreleased]: https://github.com/anthropics/imacs/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/anthropics/imacs/releases/tag/v0.1.0
