...
use crate::shipping_rate::shipping_rate;
 ...
 #[derive(Debug, Clone, Serialize, Deserialize)] pub struct OrderFlowInput { pub role: String,
...
pub member_tier: String, } #[derive(Debug, Clone, Serialize, Deserialize)] pub struct OrderFlowOutput { pub can_order: bool,
