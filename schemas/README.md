...
- `validate.schema.json` - ValidationReport output (with fixes)
...
**Note**: These schemas are auto-generated. Regenerate them after making changes to output types by running `./scripts/generate_schemas.sh`.
